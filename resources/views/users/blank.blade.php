...
<body> 
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ url('/') }}"><img src="assets/users/images/home/logo.png" alt="" /></a>
                        </div>
                        <div class="btn-group pull-right">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:void(0);">Canadian Dollar</a></li>
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php if (Auth::check()) {
                                    ...
                                    echo '<input id="user_id" type="hidden" value="'.Auth::user()->id.'">';
                                }
                                else{
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="assets/users/images/home/iframe1.png" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="assets/users/images/home/iframe2.png" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="assets/users/images/home/iframe3.png" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="assets/users/images/home/iframe4.png" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="address">
                            <img src="assets/users/images/home/map.png" alt="" />
    ...
    $("#search_box").keyup(function(event){
        if(event.keyCode == 13){
            ...
            url = url.replace(window.location.host + window.location.pathname, window.location.host + "/shop");
            url = updateQueryStringParameter(url, "q", kw);
